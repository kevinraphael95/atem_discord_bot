...
class HelpView(View):
    def __init__(self, bot, categories, prefix, category="Général"):
        ...
        self.message = None  # Référence au message pour édition
    ...
    # ──────────────────────────────────────────────────────────────
    # ⏱️ Timeout → griser tous les boutons
    # ──────────────────────────────────────────────────────────────
...
class HelpCommand(commands.Cog):
    ...
    async def help_func(self, ctx: commands.Context, commande: str = None):
        ...
        message = await safe_send(ctx.channel, embed=view.build_embed(), view=view)
